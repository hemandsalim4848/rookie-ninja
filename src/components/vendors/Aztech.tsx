...
const ifpCards = [
  {
    ...
    links: [
      ...
      { label: '65"', href: '/aztech/aztech-ideaflow-bright-65-4k-interactive-display' },
      { label: '75"', href: '/aztech/aztech-ideaflow-bright-75-4k-interactive-display' },
      { label: '86"', href: '/aztech/aztech-ideaflow-bright-86-4k-interactive-display' },
    ],
  },
  {
    ...
    links: [
      ...
      { label: 'Ideaflow Elite 110"', href: '/aztech/aztech-ideaflow-elite-110-4k-interactive-display' },
    ],
  },
];
  ...
  hypercable: {
    ...
    products: [
      ...
      },
      {
        ...
        links: [
          { label: 'HyperCable 240W 1m', href: '/aztech/aztech-hypercable-usb-c-240w-1m-black' },
          { label: 'HyperCable 240W 2m', href: '/aztech/aztech-hypercable-usb-c-240w-2m-titanium' },
        ],
      },
    ],
  },
  gan: {
    ...
    products: [
      ...
      },
      {
        ...
        links: [{ label: 'GaN 70W 3-Port', href: '/aztech/aztech-gan-hypercharger-3-ports-70w' }],
      },
    ],
  },
  car: {
    ...
    products: [
      ...
      },
      {
        ...
        links: [{ label: 'Car 95W 3-Port', href: '/aztech/aztech-gan-car-hypercharger-3-ports-95w' }],
      },
    ],
  },
};
...
const psuSeries = [
  {
    ...
    links: [
      ...
      { label: '750W', href: '/aztech/alpha-750w-80plus-gold-fully-modular-power-supply-unit' },
      { label: '850W', href: '/aztech/alpha-850w-80plus-gold-fully-modular-power-supply-unit' },
      { label: '1000W', href: '/aztech/alpha-1000w-80plus-gold-fully-modular-power-supply-unit-psu' },
      { label: '1050W', href: '/aztech/alpha-1050w-80plus-gold-fully-modular-power-supply-unit' },
    ],
  },
  {
    num: '02',
    ...
    links: [
      ...
      { label: 'NOVA 750W NM', href: '/aztech/nova-750w-white-non-modular-power-supply-unit-psu' },
      { label: 'NOVA 850W FM', href: '/aztech/nova-850w-white-fully-modular-power-supply-unit-psu' },
    ],
  },
  {
    num: '03',
    ...
    links: [
      ...
      { label: '1200W', href: '/aztech/omega-1200w-80plus-platinum-fully-modular-power-supply-unit-psu' },
      { label: '1250W', href: '/aztech/omega-1250w-80plus-platinum-fully-modular-power-supply-unit-psu' },
    ],
  },
  {
    num: '04',
    ...
    links: [
      ...
      { label: 'PRIME 750W FM', href: '/aztech/prime-750w-80plus-bronze-fully-modular-power-supply-unit' },
      { label: 'PRIME 850W FM', href: '/aztech/prime-850w-80plus-bronze-fully-modular-power-supply-unit' },
      { label: 'PRIME 1000W FM', href: '/aztech/prime-1000w-80plus-bronze-fully-modular-power-supply-unit' },
    ],
  },
];
...
const gamingPanels = [
  {
    ...
    right: {
      ...
      chips: [
        { label: 'Wireless Headset', href: '/aztech/aztech-wireless-gaming-headset-with-led' },
        { label: 'Wired Headset', href: '/aztech/aztech-wired-gaming-headset-with-microphone' },
        { label: 'Gaming Mouse', href: '/aztech/aztech-gaming-mouse-infrared-micro-switch-laser' },
        { label: 'Mechanical Keyboard', href: '/aztech/aztech-mechanical-gaming-keyboard-rgb' },
        { label: 'Mouse Pad Black', href: '/aztech/aztech-gaming-mouse-pad-black' },
        { label: 'LED Mouse Pad XL', href: '/aztech/aztech-extra-large-led-gaming-mouse-pad' },
      ],
    },
  },
  {
    ...
    right: {
      ...
      chips: [
        { label: 'Trolley LITE (32"–75")', href: '/aztech/aztech-portable-trolley-stand-lite-32-75' },
        { label: 'Trolley (55"–100")', href: '/aztech/aztech-heavy-duty-trolley-stand-55-100' },
        { label: 'Trolley PRO (42"–100")', href: '/aztech/aztech-heavy-duty-trolley-stand-pro-42-100' },
        { label: 'Trolley PRO (55"–120")', href: '/aztech/aztech-heavy-duty-trolley-stand-pro-55-120' },
        { label: 'Trolley PRO (62"–120")', href: '/aztech/aztech-heavy-duty-trolley-stand-pro-62-120' },
        { label: 'Wall Bracket LITE (14"–24")', href: '/aztech/aztech-wall-mount-bracket-lite-14-24' },
        { label: 'Wall Mount PRO (75"–120")', href: '/aztech/aztech-fixed-wall-mount-pro-75-120' },
      ],
    },
  },
];
