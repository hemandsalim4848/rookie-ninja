...
{
    name: 'Aztech',
    logo: BRAND_LOGOS.aztech,
    description: 'Networking and consumer electronics solutions.',
    category: 'Networking',
    website: '/our-vendors/aztech',
},
{
    name: 'Deli',
    logo: BRAND_LOGOS.deli,
